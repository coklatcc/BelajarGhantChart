 ...
 * @author kuupie
 */
public class SAMPLEGhantController implements Initializable {
    ...
    private void loadData(){
      ...
      IntervalCategoryDataset dataset = getCategoryDataset();
        JFreeChart chart = ChartFactory.createGanttChart("Gantt Chart Sample", "Software Development Phases", "Timeline", dataset);
        //ChartViewer viewer = new ChartViewer(chart);
        //paneView.add(new ChartViewer(chart));
        SwingNode chartSwingNode = new SwingNode();
        ChartPanel jchaChartPanel = new ChartPanel(chart);
        jchaChartPanel.setPreferredSize(new java.awt.Dimension(800, 500));
        chartSwingNode.setContent(jchaChartPanel);
        
        paneView.getChildren().addAll(chartSwingNode);
    }
